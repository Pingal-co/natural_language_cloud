"""
A simple rule-based date parser
Forked from : https://github.com/rmdort/ChatterBot/blob/timeparser/chatterbot/utils/parsing.py
"""
# -*- coding: utf-8 -*-
...
re_ordinal = 'st|nd|rd|th|first|second|third|fourth|fifth|' + re_timeframe
...
def datetime_parsing (text, base_date = datetime.now()):
    ...
    for match, value, spans in matches:
        ...
        if isSubstituted != 0:
            found_array.append((match, value.isoformat(), spans))
